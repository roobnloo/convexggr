...
n <- 200
load("tB.RData")
s <- data_generate(n, d, p, tB)
tBlist <- apply(tB, 3, function(t) t, simplify = F)
...
print(paste("TPR:", true_pos_rate(sgl_result$beta_mxs, tBlist[1:(qe+1)], qe)))
print(paste("FPR:", round(1-true_neg_rate(sgl_result$beta_mxs, tBlist[1:(qe+1)], qe), 3)))
```
